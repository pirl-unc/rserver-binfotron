...
## Building locally
```bash
docker build -t benjaminvincentlab/rserver-binfotron:4.2.1.22 .
```


## Running locally
```bash
docker run -e PASSWORD=12qwaszx --rm -p 8787:8787 -v ~/Desktop:/home/rstudio benjaminvincentlab/rserver-binfotron:4.2.1.22
```
